    ...
    public partial class KelasExecutive : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string iquery = "INSERT INTO loginform.bus (Bus_Class, Jam) VALUES ('Eksekutif', '9:00')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Lakukan operasi INSERT ke database loginform.bus
                string iquery = "INSERT INTO loginform.bus (Bus_Class, Jam) VALUES ('Eksekutif', '15:00')";
                MySqlCommand commandDatabase = new MySqlCommand(iquery, connection);
                commandDatabase.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Lakukan operasi INSERT ke database loginform.bus
                string iquery = "INSERT INTO loginform.bus (Bus_Class, Jam) VALUES ('Eksekutif', '20:00')";
                MySqlCommand commandDatabase = new MySqlCommand(iquery, connection);
                commandDatabase.ExecuteNonQuery();
